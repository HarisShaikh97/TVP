...
import { SafeAreaView, ScrollView, View, Text, Image, TouchableOpacity, StatusBar, StyleSheet } from "react-native"
...
export default function Page() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <SideNav openSideNav={openSideNav} setOpenSideNav={setOpenSideNav} handleLogout={handleLogout} />
            <AddressModal openAddressModal={openAddressModal} setOpenAddressModal={setOpenAddressModal} />
            <View style={styles.firstHeaderContainer}>
                <View style={styles.greetingsContainer}>
                    <View style={styles.greetingsHeadingContainer}>
                        <Text style={styles.greetingsHeadingText}>Good Evening, Tony</Text>
                        <Image source={require("../../assets/icons/hand-wave.png")} style={styles.greetingsImage} />
                    </View>
                    <Text style={styles.greetingsText}>Eat right! Be tight!</Text>
                </View>
                <CartButton color="#E35F21" />
            </View>
            <View style={styles.secondHeaderContainer}>
                <TouchableOpacity onPress={() => { setOpenSideNav(true) }}>
                    <Image source={require("../../assets/icons/burger-menu.png")} style={styles.secondHeaderIcons} />
                </TouchableOpacity>
                <View style={styles.locationContainer}>
                    <View style={styles.locationHeadingContainer}>
                        <Entypo name="location-pin" size={18} color="white" />
                        <Text style={styles.locationHeadingText}>{state?.selectedAddress === null ? "My Location" : state?.selectedAddress?.title}</Text>
                    </View>
                    <View style={styles.locationDetailContainer}>
                        <Text style={styles.locationDetailText} numberOfLines={1} ellipsizeMode="tail">{state?.selectedAddress === null ? "243 - Street New York city , North" : state?.selectedAddress?.address}</Text>
                        <AntDesign name="right" size={20} color="white" />
                    </View>
                </View>
                <TouchableOpacity onPress={() => {router.navigate("/search")}}>
                    <Image source={require("../../assets/icons/search.png")} style={styles.secondHeaderIcons} resizeMode="contain" />
                </TouchableOpacity>
            </View>
            <View style={styles.bodyContainer}>
                <View style={styles.tabsContainer}>
                    <TouchableOpacity
                        style={selectedTab === "delivery" && styles.selectedTabStyles}
                        onPress={() => {
                    ...
                    >
                        <Text style={selectedTab === "delivery" ? styles.selectedTabText : styles.tabText}>Delivery</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={selectedTab === "pickup" && styles.selectedTabStyles}
                        onPress={() => {
                    ...
                    >
                        <Text style={selectedTab === "pickup" ? styles.selectedTabText : styles.tabText}>Pickup</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={selectedTab === "deals" && styles.selectedTabStyles}
                        onPress={() => {
                    ...
                    >
                        <Text style={selectedTab === "deals" ? styles.selectedTabText : styles.tabText}>Deals & Discount</Text>
                    </TouchableOpacity>
                </View>
                <ScrollView style={styles?.bodyScrollArea} showsVerticalScrollIndicator={false}>
                        ...
                        <View style={styles.deliveryScrollContainer}>
                            <View style={styles.offerContainer}>
                                ...
                                <View style={styles.offerDetails}>
                                    <Text style={styles.offerText}>Order from these restaurants and save</Text>
                                    <TouchableOpacity style={styles.browseButtonContainer}>
                                        <Text style={styles.browseButtonText}>Browse offer</Text>
                                        <View style={styles.browseButtonArrowContainer}>
                                            <AntDesign name="arrowright" size={12} color="white" />
                                        </View>
                                    </TouchableOpacity>
                                </View>
                                <Image source={require("../../assets/images/offer-image.png")} style={styles.offerImage} />
                            </View>
                            <View style={styles.sectionContainer}>
                                <View style={styles.sectionHeadingContainer}>
                                    <Text style={styles.sectionHeadingTitle}>Recommended</Text>
                                    <TouchableOpacity onPress={() => {router.navigate("/recommended")}}>
                            ...
                            <View style={styles.sectionContainer}>
                                <View style={styles.sectionHeadingContainer}>
                                    <Text style={styles.sectionHeadingTitle}>Popular near you</Text>
                                    <TouchableOpacity onPress={() => {router.navigate("/popular-near-you")}}>
                                        <Text style={styles.seeAllText}>See all</Text>
                                    </TouchableOpacity>
                                </View>
                                <ScrollView horizontal style={styles.horizontalScrollArea} showsHorizontalScrollIndicator={false}>
                    ...
                    {selectedTab === "pickup" && (
                        <View style={styles.pickupScrollContainer}>
                            <View style={styles.sectionContainer}>
                                <View style={styles.sectionHeadingContainer}>
                                    <Text style={styles.sectionHeadingTitle}>Near By</Text>
                                    <TouchableOpacity onPress={() => {router.navigate("/popular-near-you")}}>
                                        <Text style={styles.seeAllText}>See all</Text>
                                    </TouchableOpacity>
                                </View>
                    ...
                    {selectedTab === "deals" && (
                        <View style={styles.dealsScrollContainer}>
                            <Image source={require("../../assets/images/coming-soon.png")} style={styles.comingSoonImage} />
                        </View>
                    )}
                </ScrollView>
            </View>
